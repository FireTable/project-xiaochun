 ...
 */
var H=Object.defineProperty;var M=Object.getOwnPropertySymbols;var P=Object.prototype.hasOwnProperty,I=Object.prototype.propertyIsEnumerable;var R=(l,t,e)=>t in l?H(l,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[t]=e,T=(l,t)=>{for(var e in t||(t={}))P.call(t,e)&&R(l,e,t[e]);if(M)for(var e of M(t))I.call(t,e)&&R(l,e,t[e]);return l};var c=(l,t,e)=>new Promise((i,r)=>{var a=n=>{try{u(e.next(n))}catch(m){r(m)}},s=n=>{try{u(e.throw(n))}catch(m){r(m)}},u=n=>n.done?i(n.value):Promise.resolve(n.value).then(a,s);u((e=e.apply(l,t)).next())});import*as v from"three";import*as w from"three";import*as _ from"three";var A={"":3e3,srgb:3001};function x(l,t){parseInt(_.REVISION,10)>=152?l.colorSpace=t:l.encoding=A[t]}var f=class{get pending(){return Promise.all(this._pendings)}constructor(t,e){this._parser=t,this._materialParams=e,this._pendings=[]}assignPrimitive(t,e){e!=null&&(this._materialParams[t]=e)}assignColor(t,e,i){if(e!=null){let r=new w.Color().fromArray(e);i&&r.convertSRGBToLinear(),this._materialParams[t]=r}}assignTexture(t,e,i){return c(this,null,function*(){let r=c(this,null,function*(){if(e!=null){let a=yield this._parser.assignTexture(this._materialParams,t,e);if(a==null){console.warn("GLTFMToonMaterialParamsAssignHelper: Failed to load texture. The rendering result may be wrong");return}i&&x(a,"srgb")}});return this._pendings.push(r),r})}assignTextureByIndex(t,e,i){return c(this,null,function*(){return this.assignTexture(t,e!=null?{index:e}:void 0,i)})}};import*as o from"three";var L=`// #define PHONG

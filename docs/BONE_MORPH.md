...
| **`torsoLength`** | Torso / Shoulders | `1.00` | `0.75 ~ 1.35` | `0.01` | Lumbar spine length (Height) | Pure orthogonal vertical translation (22% Spine, 48% Chest, 30% UpperChest); pelvic base locked, zero leg distortion. |
